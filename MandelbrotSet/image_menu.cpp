...
int imageMenu(std::istream &is, std::ostream &os)
{
    ...
    while (choice != "quit")
    {
        ...
        {
            takeAction(is, sstream, choice, input_image1, input_image2, output_image, *gptr);
...
int runFile(std::istream &is, std::ostream &os, PPM &input_image1, PPM &input_image2, PPM &output_image)
{
    ...
    while (choice != "quit" && myfile.good())
    {
        ...
        takeAction(myfile, stream1, choice, input_image1, input_image2, output_image, *gptr);
    }
    return 0;
}
...
void setJuliaFractal( std::istream& is, std::ostream& os, NumberGrid
& grid ){
