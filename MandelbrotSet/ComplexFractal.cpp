...
ComplexFractal::ComplexFractal( ):NumberGrid(){
...
ComplexFractal::ComplexFractal( const int& height, const int& width, const double& min_x, const double& max_x, const double& min_y, const double& max_y ): NumberGrid(height, width){
	 mDeltaX = .01;
	 mDeltaY = .01;
	 mMaxX = max_x;
	 mMinX = min_x;
