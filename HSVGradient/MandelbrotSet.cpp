...
MandelbarSet::MandelbarSet(const int& height, const int& width, const double& min_x, const double& max_x, const double& min_y, const double& max_y):MandelbrotSet(height,width,min_x,max_x,min_y,max_y){
